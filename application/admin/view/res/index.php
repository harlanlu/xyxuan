    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            ...
            <div class="layui-card layui-form">
                                        ...
                                        <div class="layui-col-md2 layui-col-sm4 text-center">
                                            <?php if ($image['category'] == 'directory') { ?>
                                                <div class="text-center" >
                                                    ...
                                                    <label>
                                                        <input lay-ignore class="ids" type="checkbox" name="path[]" value="<?php echo $image['path']; ?>" />
                                                        <?php echo $image['name']; ?>
                                                    </label>
                                                </div>
                                            <?php } ?>
                            ...
                            <div class="layui-row">
                                <table class="layui-table">
                                    ...
                                    <?php foreach ($data['images'] as $image) { ?>
                                        <?php if ($image['category'] == 'directory') { ?>
                                            <tr>
                                                <td><input class="ids" type="checkbox" lay-ignore  name="path[]" value="<?php echo $image['path']; ?>" />
                                        ...
                                        <?php if ($image['category'] == 'image') { ?>
                                            <tr >
                                                <td>
                                                    <input class="ids" type="checkbox" lay-ignore  name="path[]" value="<?php echo $image['path']; ?>" />
                ...
                <div class="layui-card-body">
                    <ul class="common">
                        <li><input class="all-file" lay-ignore type="checkbox"/> 全选  </li>
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                if (result.code == 0) {
                                    <?php if ($folder == 'image') { ?>
                                    if (result.data) {
                                        parent_img_select(result.data.thumb, result.data.hidden);
                                    }
                                    <?php } else { ?>
                                    if (result.data) {
