                                ...
                                <tbody id="tbody">
                                    ...
                                    foreach ($lists[0] as $key2 => $value2) {
                                        ...
                                        <tr id="gallery-image-row<?php echo $key2; ?>"> 
                                            ...
                                            <td><input type="<?php if ($lists[1][$key2]=='smtp_pass') echo "password"; else echo "text"; ?>" name="configs[<?php echo $key2; ?>][value]" value="<?php echo $lists[2][$key2] ?>" class="layui-input"></td>
