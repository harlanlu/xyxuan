...
<html class="x-admin-sm">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="<?php echo url('admin/index/index') ?>">新意轩摄影</a></div>
            <div class="left_open">
                ...
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('前台申请认证', '<?php echo url('admin/member/apply_identify') ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>前台申请认证</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('用户购买记录', '<?php echo url('admin/member/buy') ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户购买记录</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('网站栏目', '<?php echo url('admin/thread/column') ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>网站栏目</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('网站作品', '<?php echo url('admin/thread/iframe') ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>网站作品</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('外链列表', '<?php echo url('admin/nav/iframe') ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>外链列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('外链分类', '<?php echo url('admin/nav/category') ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>外链分类</cite></a>
                            </li>
                        </ul>
