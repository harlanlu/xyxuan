                        ...
                        <form action="" method="post">
                            ...
                            <div class="layui-row layui-col-space15 layui-form-item">
                                ...
                                <div class="form-group layui-col-md6" >
                                    <label class="sr-only" for="my"></label>
                                    <div class="input-group">
                                        <div class="input-group-addon">栏目父类</div>
                                        <select class="form-control" required name="pid" lay-ignore id="ppid">
                                            <option value="{$pid}" selected>{$pid|getCateName}</option>
                                        </select>
                                ...
                                <div class="form-group layui-col-md6" >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" required name="cid" lay-ignore id="ccid" >
                                            <option value="{$cid}">{$cid|getCateName}</option>
                                        </select>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline" style="width: 190px;">
                                        <textarea name="lianjie" id="" cols="40" rows="5" class="layui-textarea">{$one['lianjie']}</textarea>

<!--                                        <input type="text" id="" name="lianjie"  value="{$one['lianjie']}" autocomplete="off" class="layui-input">-->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline" style="width: 190px;">
                                        <input type="number" id="" name="points" required value="{$points}" lay-verify="required" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                <button style="width: 120px;" class="layui-btn" lay-filter="myform" lay-submit>更新</button>
                            </div>
                        </form>
                    </div>
                </div>
