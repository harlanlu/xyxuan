<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="user">
    ...
    <li class="layui-nav-item <?php
    if (request()->action() == 'apply_identify') {
        echo 'layui-this';
    }
    ?>" >
        <a href="<?php echo url('index/member/apply_identify') ?>">
            <i class="layui-icon">&#xe65d;</i>
            申请摄影师
        </a>
    </li>
    ...
    <li class="layui-nav-item <?php
    if (request()->action() == 'jifen') {
        echo 'layui-this';
    }
    ?> ">
        <a href="<?php echo url('index/member/jifen') ?>">
            <i class="layui-icon">&#xe698;</i>
            我的积分
        </a>
    </li>
