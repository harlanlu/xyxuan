...
<div class="fly-home fly-panel" style="background-image: url();">
    <img src="<?php
    echo isset($avatar) ? res_http($avatar) : res_http('sex' . $sex . '.png');
    ...
    <?php } ?>
    <div class="fly-sns" data-id="{$id}" data-name="{$nickname}">
        <?php
...
<div class="layui-container">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md6 fly-home-jie">
            <div class="fly-panel">
                <h3 class="fly-panel-title"><?php echo $nickname ?> 最近的作品</h3>
                <ul class="jie-row">
                    <?php
                    if (count($recent_thread_lists) > 0) {
                        foreach ($recent_thread_lists as $key => $value) {
                            ...
                            <li>
                                ...
                                <em class="layui-hide-xs"><?php echo $value['hits'] ?>阅/<?php echo $value['hits_comment'] ?>回</em>
                            </li>
                            <?php
                        }
                    } else {
                        ?>
                        <div class="fly-none" style="min-height: 50px; padding:30px 0; height:auto;"><i style="font-size:14px;">没有发表任何作品</i></div>
                    <?php } ?>
                </ul>
            </div>
        </div>
